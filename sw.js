...
self.addEventListener("fetch", (e) => {
  ...
  // Tuiles/style/polices OSM (OpenFreeMap) + moteur MapLibre (unpkg) : cache-first → utilisables hors-ligne.
  if (url.hostname === "tiles.openfreemap.org" || url.hostname === "unpkg.com") {
    e.respondWith(
